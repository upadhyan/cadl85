...
A self-contained end-to-end example is in [demo.py](demo.py) — it generates a synthetic binary dataset, fits a tree, prints predictions and search stats, and pretty-prints the learned tree structure.
